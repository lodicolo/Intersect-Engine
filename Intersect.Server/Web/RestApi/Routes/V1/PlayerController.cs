...
[Route("players")]
[Authorize]
public sealed partial class PlayerController : IntersectControllerBase
{
    ...
    [Route("{lookupKey:LookupKey}/variables/{variableId:guid}")]
    [HttpPost]
    public object PlayerVariableSet(LookupKey lookupKey, Guid variableId, [FromBody] VariableValuePayload valuePayload)
    {
        if (lookupKey.IsInvalid)
        {
            return CreateErrorResponse(
    ...
    public object PlayerClassSet(LookupKey lookupKey, [FromBody] ClassChange change)
    {
        ...
        {
            return CreateErrorResponse(HttpStatusCode.BadRequest, $@"Invalid class id ${change.ClassId}.");
        }
    ...
    public object ItemsListBag(Guid bagId)
    {
        if (bagId == Guid.Empty)
        {
            return CreateErrorResponse(HttpStatusCode.BadRequest, @"Invalid bag id.");
        }
        ...
        if (bag == null)
        {
            return CreateErrorResponse(HttpStatusCode.NotFound, @"Bag does not exist.");
        }
        else
        {
            return bag;
    ...
    public object ItemsGive(LookupKey lookupKey, [FromBody] ItemInfo itemInfo)
    {
        ...
        {
            return CreateErrorResponse(HttpStatusCode.BadRequest, @"Invalid item id.");
        }
    ...
    public object SpellsTeach(LookupKey lookupKey, [FromBody] SpellInfo spell)
    {
        ...
        {
            return CreateErrorResponse(HttpStatusCode.BadRequest, @"Invalid spell id.");
        }
