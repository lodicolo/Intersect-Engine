...
internal class ApiGrantCommand : TargetUserCommand
{
    public ApiGrantCommand() : base(
        ...
        new VariableArgument<string>(
            Strings.Commands.Arguments.ApiRole,
            RequiredIfNotHelp,
            true
        )
    ) { }
    ...
    )
    {
        ...
        {
            Console.WriteLine(
                Strings.Commandoutput.apirolenotgranted.ToString(
                    role,
                    target.Name
                )
            );
                 ...
                 ))
        {
            ...
            {
                Console.WriteLine(
                    Strings.Commandoutput.apiroleprereq.ToString(
                        role,
                        "users.query"
                    )
                );
        ...
        Console.WriteLine(
            Strings.Commandoutput.apirolegranted.ToString(
                target.Name,
                role
            )
        );
