...
internal sealed class CpsCommand : HelpableCommand
{
    ...
    )
    {
        ...
        Console.WriteLine(
            Options.Instance.Processing.CpsLock ? Strings.Commandoutput.cpslocked.ToString() + " (" + Globals.Cps + ")"
                : Strings.Commandoutput.cpsunlocked.ToString() + " (" + Globals.Cps + ")"
        );
    }
}
