...
namespace Intersect.Server.Migrations
{
    ...
    [Migration("20201120021143_AddGroupMembership")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Intersect.Server.Database.PlayerData.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("Intersect.Server.Database.PlayerData.GroupMembership", b =>
                {
            ...
            modelBuilder.Entity("Intersect.Server.Database.PlayerData.GroupMembership", b =>
                {
                    b.HasOne("Intersect.Server.Database.PlayerData.Group", "Group")
                        .WithMany("Memberships")
                        .HasForeignKey("GroupId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("Intersect.Server.Entities.Player", "Member")
