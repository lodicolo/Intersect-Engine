...
public static partial class AssemblyExtensions
{
    ...
    {
        await assembly.UnpackEmbeddedFileAsync(
            cancellationToken,
            resourceName,
            fileInfo,
            new FileOverwriter
            {
                OverwriteBehavior = overwrite ? OverwriteBehavior.Overwrite : OverwriteBehavior.DoNotOvewrite
            }
        );
    }
    ...
    {
        if (!fileOverwriter.CanWriteTo(fileInfo.FullName))
        {
            return;
        }
