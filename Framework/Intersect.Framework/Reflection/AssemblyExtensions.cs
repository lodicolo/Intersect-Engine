    ...
    )
    {
        ...
        if (!assembly.TryFindResource(resourceName, out var manifestResourceName))
        {
            throw new MissingManifestResourceException(
                string.Format(AssemblyExtensionsResources.UnpackEmbeddedFile_MissingManifestResourceInfo, resourceName)
            );
        }
        ...
        {
            throw new MissingManifestResourceException(
                string.Format(AssemblyExtensionsResources.UnpackEmbeddedFile_UnableToOpenStream, manifestResourceName)
            );
        }
