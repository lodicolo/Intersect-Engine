...
public interface ICommandArgument<TValue> : ICommandArgument
{
    new TValue DefaultValue { get; }

    object? ICommandArgument.DefaultValue => DefaultValue;

    new TValue ValueTypeDefault => default!;

    object? ICommandArgument.ValueTypeDefault => ValueTypeDefault;
}
