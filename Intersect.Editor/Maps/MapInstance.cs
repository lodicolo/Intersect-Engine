...
namespace Intersect.Editor.Maps
{
    ...
    public partial class MapInstance : MapBase, IGameObject<Guid, MapInstance>, IMapInstance
    {
                        ...
                        for (var y = 0; y < Options.MapHeight; y++)
                        {
                            ...
                            if (tileset != null)
                            {
                                var tilesetTex = Globals.ContentManager.GetTexture(
                                    Client.Framework.Content.TextureType.Tileset, tileset.Name
                                );
        ...
        public void DrawItemsAndLights()
        {
            ...
            foreach (var itemCollection in MapItems)
            {
                ...
                for (var index = tileItems.Count - 1; index >= 0; index--)
                {
                    ...
                    var itemTex = Globals.ContentManager.GetTexture(Client.Framework.Content.TextureType.Item, itemBase.Icon);
                    if (itemTex != null)
                    {
        ...
        public void DrawFog()
        {
            ...
            {
                var fogTex = Globals.ContentManager.GetTexture(Client.Framework.Content.TextureType.Fog, Fog);
                if (fogTex != null)
                {
        ...
        public void DrawPanorama()
        {
            ...
            var imageTex = Globals.ContentManager.GetTexture(Client.Framework.Content.TextureType.Image, Panorama);
            if (imageTex != null)
            {
        ...
        public void DrawOverlayGraphic()
        {
            ...
            var imageTex = Globals.ContentManager.GetTexture(Client.Framework.Content.TextureType.Image, OverlayGraphic);
            if (imageTex != null)
            {
