...
public class VariableValue
{
    ...
    [NotMapped] public dynamic Value { get => mValue; set => SetValue(value); }
    ...
    public static implicit operator VariableValue(bool value) => new()
    {
        Type = VariableDataType.Boolean,
        Boolean = value
    };

    public static implicit operator bool(VariableValue variableValue) => variableValue.Boolean;

    public static implicit operator VariableValue(long value) => new()
    {
        Type = VariableDataType.String,
        Integer = value
    };

    public static implicit operator long(VariableValue variableValue) => variableValue.Integer;

    public static implicit operator VariableValue(double value) => new()
    {
        Type = VariableDataType.Number,
        Number = value
    };

    public static implicit operator double(VariableValue variableValue) => variableValue.Number;

    public static implicit operator VariableValue(string value) => new()
    {
        Type = VariableDataType.String,
        String = value
    };

    public static implicit operator string(VariableValue variableValue) => variableValue.String;
