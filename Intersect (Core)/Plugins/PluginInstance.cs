...
namespace Intersect.Plugins
{
    ...
    public class PluginInstance
    {
        ...
        [NotNull]
        [SuppressMessage("Design", "CA1062:Validate arguments of public methods", Justification = SuppressionJustifications.NotNullJetBrains)]
        public static PluginInstance Create([NotNull] Plugin plugin)
        {
