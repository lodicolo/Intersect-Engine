...
namespace Intersect.Core
{
        ...
        where TServiceImplementation : ApplicationService<TServiceInterface, TServiceImplementation>, TServiceInterface
    {
        ...
        protected abstract void TaskStart([NotNull] IApplicationContext applicationContext);
        ...
        protected abstract void TaskStop([NotNull] IApplicationContext applicationContext);
